DROP DATABASE IF EXISTS Wholesale_Distributor_Hibernate_Layard;
CREATE DATABASE IF NOT EXISTS Wholesale_Distributor_Hibernate_Layard;
SHOW DATABASES ;
USE Wholesale_Distributor_Hibernate_Layard;
#-------------------
